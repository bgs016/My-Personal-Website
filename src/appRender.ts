    ...
    <section id="top" class="intro" aria-labelledby="intro-title">
      <div class="intro-grid">
        <div class="intro-copy">
          ...
          <p class="hero-lead">Senior Product Manager in AI, innovative HW/SW products, and product strategy.</p>
  ...
  return `
    <section id="contact" class="section section-tint section-contact" aria-labelledby="contact-title">
      <div class="contact-section__inner">
        <div class="prose prose--contact contact-section__prose">
          <h2 id="contact-title" class="section-heading section-heading--contact">Contact Me</h2>
          <p class="contact-section__lead">
            For collaboration, opportunities, or a conversation—reach out through any of the channels below.
          </p>
          <ul class="contact-list contact-list--centered">
            <li>
              <a
